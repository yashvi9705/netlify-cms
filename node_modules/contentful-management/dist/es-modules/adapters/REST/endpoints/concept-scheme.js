...
export const get = (http, params) => raw.get(http, `${basePath(params.organizationId)}/${params.conceptSchemeId}`);
export const del = (http, params, headers) => raw.del(http, `${basePath(params.organizationId)}/${params.conceptSchemeId}`, {
